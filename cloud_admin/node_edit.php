...
if(!empty($_POST)){
    ...
    $query = $node->Update($node_name,$node_type,$node_server,$node_method,$node_info,$node_status,$node_order,$node_key,$node_ip,$node_free);
    if($query){
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" method="post" action="node_edit.php">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="cate_title">通信密钥</label>
                                <input  class="form-control" name="node_key" value="<?php echo $rs['node_key'];?>" >
                            </div>
                            
                            <div class="form-group">
                                <label for="cate_title">服务器ip</label>
                                <input  class="form-control" name="node_ip" value="<?php echo $rs['node_ip'];?>" >
                            </div>
                            
                            <div class="form-group">
                                <label for="cate_title">服务器性质(1付费,0通用)</label>
                                <input  class="form-control" name="node_free" value="<?php echo $rs['node_free'];?>" >
                            </div>
                        </div><!-- /.box-body -->
