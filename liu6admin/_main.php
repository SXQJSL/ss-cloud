...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="../asset/js/html5shiv/3.7.0/html5shiv.js"></script>
    <script src="../asset/js/respond.js/1.3.0/respond.min.js"></script>
    <![endif]-->
</head>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <ul class="treeview-menu">
                <li><a href="user.php"><i class="fa fa-circle-o"></i>付费用户</a></li>
                <li><a href="user.php"><i class="fa fa-circle-o"></i>免费用户</a></li>
              </ul>
            </li>
               ...
               <li>
                    <a href="plan.php">
                        <i class="fa fa-users"></i> <span>套餐管理</span>
                    </a>
               </li>
               
               <li>
                    <a href="flow_code.php">
                        <i class="fa fa-users"></i> <span>流量卡管理</span>
                    </a>
               </li>
